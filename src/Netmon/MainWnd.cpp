...
INT_PTR CALLBACK MainWindow::ProcDlgMainEx(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
{
	// Display the window
	m_hWnd = CreateDialogParam(m_hInstance, _T("DLG_MAIN"), NULL, ProcDlgMainEx, 0);
}

LRESULT MainWindow::LoopMessage()
{
	MSG Msg;
	LOGT(_T("进入窗口消息循环"));
